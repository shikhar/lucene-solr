...
public class IndexSearcher {
  ...
  /**
   * Creates a searcher searching the provided top-level {@link IndexReader}.
   *
   * @see IndexReaderContext
   * @see IndexReader#getContext()
   * @see SerialSearchStrategy
   * @lucene.experimental
   */
  ...
  public IndexSearcher(IndexReaderContext context) {
    this(context, new SerialSearchStrategy());
  }

  /**
   * Creates a searcher searching the provided top-level {@link IndexReader} and {@link SearchStrategy}.
   *
   * @see IndexReaderContext
   * @see IndexReader#getContext()
   * @see SearchStrategy
   * @lucene.experimental
   */
  public IndexSearcher(IndexReader reader, SearchStrategy searchStrategy) {
    this(reader.getContext(), searchStrategy);
  }

  /**
   * Creates a searcher searching the provided top-level {@link IndexReaderContext} and {@link SearchStrategy}.
   *
   * @see IndexReaderContext
   * @see IndexReader#getContext()
   * @see SearchStrategy
   * @lucene.experimental
   */
  public IndexSearcher(IndexReaderContext context, SearchStrategy searchStrategy) {
  ...
  protected void search(List<LeafReaderContext> leaves, Weight weight, Collector collector)
      throws IOException {
    searchStrategy.search(leaves, weight, collector);
  }
  ...
  public String toString() {
    return "IndexSearcher(" + reader + "; searchStrategy=" + searchStrategy + ")";
  }
