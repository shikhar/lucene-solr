...
public class TestTopFieldCollector extends LuceneTestCase {
  ...
  // MultiComparatorScoringNoMaxScoreLeafCollector
  ...
  public void testOutOfOrderDocsScoringSort() throws Exception {
    ...
    String[] actualTFCClasses = new String[] {
        "OutOfOrderOneComparatorNonScoringLeafCollector",
        "OutOfOrderOneComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderOneComparatorScoringNoMaxScoreLeafCollector",
        "OutOfOrderOneComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderOneComparatorNonScoringLeafCollector",
        "OutOfOrderOneComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderOneComparatorScoringNoMaxScoreLeafCollector",
    ...
    for(int j = 0; j < tfcOptions.length; j++) {
      ...
      LeafCollector sub = tdc.getLeafCollector(ir.leaves().get(0));
  ...
  public void testOutOfOrderDocsScoringSortMulti() throws Exception {
    ...
    String[] actualTFCClasses = new String[] {
        "OutOfOrderMultiComparatorNonScoringLeafCollector",
        "OutOfOrderMultiComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderMultiComparatorScoringNoMaxScoreLeafCollector",
        "OutOfOrderMultiComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderMultiComparatorNonScoringLeafCollector",
        "OutOfOrderMultiComparatorScoringMaxScoreLeafCollector",
        "OutOfOrderMultiComparatorScoringNoMaxScoreLeafCollector",
